 ...
 */
final class Version20220608180945 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne ADD profile_id INT DEFAULT NULL, ADD job_id INT DEFAULT NULL, DROP job, CHANGE name name VARCHAR(50) NOT NULL, CHANGE age age SMALLINT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne ADD job VARCHAR(50) DEFAULT NULL, DROP profile_id, DROP job_id, CHANGE name name VARCHAR(60) NOT NULL, CHANGE age age INT NOT NULL');
    }
}
